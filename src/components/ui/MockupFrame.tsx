...
export function MockupFrame({ children, className }: MockupFrameProps) {
  return (
    <div
      className={cn(
        "relative mx-auto rounded-[3rem] border-[12px] border-slate-900 bg-slate-900 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.3)] overflow-hidden transition-all duration-700 hover:shadow-[0_60px_120px_-20px_rgba(0,0,0,0.4)] hover:scale-[1.02]",
    ...
    >
      ...
      <div className="absolute top-0 inset-x-0 h-7 flex justify-center z-20">
        <div className="w-32 h-full bg-slate-900 rounded-b-2xl flex justify-center items-center gap-3">
      ...
      <div className="relative z-10 w-full h-full bg-white rounded-[2rem] overflow-hidden">
        {children}
      </div>
    </div>
  );
