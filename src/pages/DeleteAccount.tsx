...
const DeleteAccount = () => {
  ...
  return (
    <PageLayout mainClassName="bg-slate-950 text-slate-50">
      <div className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative z-10 mx-auto flex min-h-[calc(100vh-64px)] max-w-5xl flex-col gap-10 px-4 py-12 sm:px-6 lg:px-8">
          ...
          <Card className="border-slate-800/80 bg-slate-900/80 text-slate-50 shadow-2xl backdrop-blur">
              ...
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="border-slate-700 bg-slate-900/60 text-slate-50 placeholder:text-slate-400 focus-visible:ring-cyan-400 focus-visible:ring-offset-0"
                  />
                  <p className="text-xs text-slate-400">Used to locate your account in Firebase Auth.</p>
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="reason" className="text-slate-100">
                    Reason for deletion (optional)
                  </Label>
                  <select
                    id="reason"
                    name="reason"
                    className="w-full rounded-md border border-slate-700 bg-slate-900/60 px-3 py-2 text-sm text-slate-50 shadow-sm outline-none ring-offset-0 transition focus:border-cyan-300 focus:ring-2 focus:ring-cyan-400"
                    defaultValue=""
                  >
                    ...
                    {reasonOptions.map((option) => (
                      <option key={option} value={option} className="bg-slate-900 text-slate-50">
                        {option}
                      </option>
                    ))}
                  </select>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    className="min-h-[96px] border-slate-700 bg-slate-900/60 text-slate-50 placeholder:text-slate-400 focus-visible:ring-cyan-400 focus-visible:ring-offset-0"
                  />
                </div>
                ...
                <div className="flex items-start gap-3">
                  <input
                    ...
                    type="checkbox"
                    required
                    className="mt-1 h-4 w-4 cursor-pointer rounded border border-slate-500 bg-slate-900 accent-cyan-400"
                  />
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                  ...
                  <Button
                    ...
                    disabled={isCopying}
                    onClick={handleCopy}
                    className="h-11 flex-1 border-slate-700 bg-slate-900/60 text-slate-50 hover:border-cyan-300 hover:bg-slate-800"
                  >
          ...
          <Card className="border-slate-800/80 bg-slate-900/60 text-slate-50 shadow-xl backdrop-blur">
            <CardHeader className="pb-3">
              <CardTitle className="text-xl">What happens next</CardTitle>
              <CardDescription className="text-slate-300">Data handling and timeline</CardDescription>
            </CardHeader>
            <CardContent className="space-y-3 text-sm leading-6 text-slate-200">
              ...
              <p className="text-slate-300">Developer: Wequitech — Contact: {SUPPORT_EMAIL} — App: {APP_NAME}.</p>
            </CardContent>
          </Card>
        </div>
      </div>
